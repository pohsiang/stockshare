...
for stockid in stockid_list:
    ...
    if result_400_one_month > result_400 and result_1000_one_month > result_1000:
        print(str(stockid) + ", result_400_one_month:" + str(result_400_one_month) + ", result_400:" + str(result_400) + ", result_1000_one_month:" + str(result_1000_one_month) + ", result_1000:" + str(result_1000) )
